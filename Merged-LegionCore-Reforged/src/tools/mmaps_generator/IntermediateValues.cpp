...
namespace MMAP
{
    ...
    void IntermediateValues::writeIV(uint32 mapID, uint32 tileX, uint32 tileY)
    {
        ...
        std::string name("ClientData/meshes/%04u%02i%02i.");
...
#undef DEBUG_WRITE
    ...
    void IntermediateValues::generateObjFile(uint32 mapID, uint32 tileX, uint32 tileY, MeshData &meshData)
    {
        ...
        sprintf(objFileName, "ClientData/meshes/map%04u%02u%02u.obj", mapID, tileY, tileX);
        ...
        sprintf(objFileName, "ClientData/meshes/%04u.map", mapID);
        ...
        sprintf(objFileName, "ClientData/meshes/%04u%02u%02u.mesh", mapID, tileY, tileX);
        objFile = fopen(objFileName, "wb");
        if (!objFile)
        {
            char message[1024];
